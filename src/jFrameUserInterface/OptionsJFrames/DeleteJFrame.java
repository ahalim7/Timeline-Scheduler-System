 ...
 * @author Abdelhalim
 */
public class DeleteJFrame extends JFrame implements ICommonInterface,
        ICommonLayoutMethods, ActionListener {

    /**
     * declare the layout variable and its constraints
     */
    ...
    public void setComponentSize() {
        ...
        addComponent(jButtonDelete, 4, 2, constraints);
